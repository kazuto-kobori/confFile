  ...
  let s:guishade1 = "#d9d9ca"
  let s:guishade2 = "#b5bcb2"
  let s:guishade3 = "#919f99"
  let s:guishade4 = "#6c8280"
  let s:guishade5 = "#486567"
  let s:guishade6 = "#24484f"
  let s:guishade7 = "#002b36"
  let s:guiaccent0 = "#dc322f"
  let s:guiaccent1 = "#cb4b16"
  let s:guiaccent2 = "#b58900"
  let s:guiaccent3 = "#859900"
  let s:guiaccent4 = "#002b36"
